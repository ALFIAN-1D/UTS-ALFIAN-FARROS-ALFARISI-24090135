/*Minimarket Mekar Raos – FINAL VERSION (LIST MODE + EDIT)*/

const APP_KEY = "Minimarket_Mekar_Raos_app_v1";
...
/*AUTH*/
function isLoggedIn() {
  return sessionStorage.getItem("Minimarket_Mekar_Raos_logged") === "1";
}
...
function setupLogin() {
  ...
  form.addEventListener("submit", (e) => {
    ...
    sessionStorage.setItem("Minimarket_Mekar_Raos_logged", "1");
...
function setupProductsList() {
  ...
  if (state.products.length === 0) {
    state.products = [
      { id: 1, name: "Minuman Kopi", price: 5000 },
      { id: 2, name: "Roti Aoka", price: 3000 },
      { id: 3, name: "Buku Tulis", price: 5000 },
    ];
    saveData(state);
  }
